...
export default class IntroSection
{
    ...
    setTitles()
    {
        ...
        this.objects.add({
            base: this.resources.items.introA2Base.scene,
            collision: this.resources.items.introA2Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introA3Base.scene,
            collision: this.resources.items.introA3Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introPBase.scene,
            collision: this.resources.items.introPCollision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            duplicated: true,
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
        ...
        this.objects.add({
            base: this.resources.items.introA4Base.scene,
            collision: this.resources.items.introA4Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introC2Base.scene,
            collision: this.resources.items.introC2Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            duplicated: true,
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
